...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "radial-gradient(circle at top, #2b0036 0%, #090909 60%)", color: "white", fontFamily: "Arial", padding: "40px", textAlign: "center" }}>
      ...
      <button onClick={() => window.open("https://buy.stripe.com/test_7sYbJ12NG16y4K76Zh9R600")} style={{ background: "#ffd700", color: "#111", border: "none", padding: "12px 20px", borderRadius: "12px", marginBottom: "25px", fontWeight: "bold", cursor: "pointer" }}>
      ...
      {mostrar && (
        <div style={{ marginTop: "40px", background: "rgba(255,255,255,0.08)", padding: "30px", borderRadius: "24px", maxWidth: "850px", marginInline: "auto" }}>
          <img src={imagem} alt="" style={{ width: 180, background: "white", borderRadius: 20 }} />
