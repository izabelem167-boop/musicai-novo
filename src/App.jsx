    ...
    <div style={styles.page}>
      ...
      {resultado && (
        <div style={styles.resultCard}>
          <img src={imagem} alt="Artista IA" style={styles.avatar} />

          <div style={styles.artistHeader}>
            <div style={styles.verifiedRow}>
              <h2 style={styles.artistName}>🎤 {nome.toUpperCase()}</h2>
              <div style={styles.verifiedBadge}>✔ Verified Artist</div>
            </div>
            ...
            <p style={styles.listeners}>🎧 1.2M ouvintes mensais</p>
          </div>
          ...
          <div style={styles.musicPlayer}>
            ...
            <div style={{ flex: 1 }}>
              <div style={styles.songTitle}>{tema}</div>
              ...
              <div style={styles.time}>0:32 / 2:14</div>
            </div>
          </div>
